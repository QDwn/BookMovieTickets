    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signupButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String role = email.equals("admin@gmail.com") ? "admin" : "user"; // Xác định vai trò

                // Sử dụng constructor mới của HelperClass với 'role'
                ...
                // Điều này phù hợp với logic kiểm tra người dùng trong LoginActivity
